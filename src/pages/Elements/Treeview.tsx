                        ...
                        <ul className="font-semibold">
                            <li className="py-[5px]">
                                <Collapsible.Root className="w-[300px]" open={open} onOpenChange={setOpen}>
                                    ...
                                    <Collapsible.Content>
                                        <ul className="ltr:pl-14 rtl:pr-14">
                                            <li className="py-[5px]">style.css</li>
                                        </ul>
                                    </Collapsible.Content>
                                </Collapsible.Root>
                            </li>
                            <li className="py-[5px]">
                                <Collapsible.Root className="w-[300px]" open={open1} onOpenChange={setOpen1}>
                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                        <Collapsible.Trigger asChild>
                                            <button type="button">
                                                <svg
                                    ...
                                    <Collapsible.Content>
                                        <ul className="ltr:pl-14 rtl:pr-14">
                                            <li className="py-[5px]">profile-16.jpeg</li>
                                            <li className="py-[5px]">background.png</li>
                                            <li className="py-[5px]">gallery.jpg</li>
                                        </ul>
                                    </Collapsible.Content>
                                </Collapsible.Root>
                            </li>
                            <li className="py-[5px]">
                                <Collapsible.Root className="w-[300px]" open={open2} onOpenChange={setOpen2}>
                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                        <Collapsible.Trigger asChild>
                                            <button type="button">
                                                <svg
                                    ...
                                    <Collapsible.Content>
                                        <ul className="ltr:pl-14 rtl:pr-14">
                                            <li className="py-[5px]">
                                                <Collapsible.Root className="w-[300px]" open={open3} onOpenChange={setOpen3}>
                                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                                        <Collapsible.Trigger asChild>
                                                            <button type="button">
                                                                <svg
                                                    ...
                                                    <Collapsible.Content>
                                                        <ul className="ltr:pl-14 rtl:pr-14">
                                                            <li className="py-[5px]">file name</li>
                                                            <li className="py-[5px]">file name</li>
                                                            <li className="py-[5px]">file name</li>
                                                        </ul>
                                                    </Collapsible.Content>
                                            ...
                                            <li className="py-[5px] ltr:pl-8 rtl:pr-8">file name</li>
                                            <li className="py-[5px] ltr:pl-8 rtl:pr-8">file name</li>
                                        </ul>
                                    </Collapsible.Content>
                                </Collapsible.Root>
                            ...
                            <li className="py-[5px] ltr:pl-7 rtl:pr-7">index.html</li>
                            <li className="py-[5px] ltr:pl-7 rtl:pr-7">components.html</li>
                        </ul>
                    </div>
                    {codeArr.includes('code1') && (
                        <CodeHighlight>
