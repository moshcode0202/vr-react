                        ...
                        <div className="mb-5">
                            <div className="flex justify-center w-full gap-4">
                                <Popover.Root>
                                    ...
                                    <Popover.Portal>
                                        <Popover.Content side="top" className="bg-black text-white border rounded p-0.5">
                        ...
                        <div className="mb-5">
                            <div className="flex flex-wrap justify-center gap-4 w-full">
                                ...
                                <Popover.Root>
                                    ...
                                    <Popover.Portal>
                                        <Popover.Content side="left" className="bg-black text-white border rounded p-0.5 ">
                                            Popover on left
                                            <Popover.Arrow className="fill-black" />
                                        </Popover.Content>
                                    </Popover.Portal>
                                ...
                                <Popover.Root>
                                    ...
                                    <Popover.Portal>
                                        <Popover.Content side="right" className="bg-black text-white border rounded p-0.5 ">
                                            Popover on right
                                            <Popover.Arrow className="fill-black" />
                                        </Popover.Content>
                                    </Popover.Portal>
                                ...
                                <Popover.Root>
                                    ...
                                    <Popover.Portal>
                                        <Popover.Content arrowPadding={50} side="bottom" className="bg-black text-white border rounded p-0.5 ">
                                            Popover on bottom
                                            <Popover.Arrow className="fill-black" />
                                        </Popover.Content>
                                    </Popover.Portal>
                        ...
                        <div className="mb-5">
                            <div className="flex flex-wrap justify-center gap-4 w-full">
                                <Popover.Root>
                                    ...
                                    <Popover.Portal>
                                        <Popover.Content onInteractOutside={(e) => e.preventDefault()} side="top" className="bg-black text-white border rounded p-0.5 ">
                                            On Hover
                                            <Popover.Arrow className="fill-black" />
                                        </Popover.Content>
                                    </Popover.Portal>
                                ...
                                <Popover.Root>
                                    ...
                                    <Popover.Portal>
                                        <Popover.Content hideWhenDetached side="top" className="bg-black text-white border rounded p-0.5 ">
                                            On Focus
                                            <Popover.Arrow className="fill-black" />
                                        </Popover.Content>
                                    </Popover.Portal>
                                ...
                                <Popover.Root>
                                    ...
                                    <Popover.Portal>
                                        <Popover.Content arrowPadding={50} side="top" className="bg-black text-white border rounded p-0.5 ">
                                            Delay 1s
