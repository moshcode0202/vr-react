                            ...
                            <div className="mb-5">
                                <div className="space-y-2">
                                    ...
                                    <div className="flex">
                                        ...
                                        >
                                            <Checkbox.Indicator>
                                                <CheckIcon className="text-danger" />
                                            </Checkbox.Indicator>
                                        </Checkbox.Root>
                                        <label className="inline-flex mx-2">
                                            <span>Danger</span>
...
<label className="inline-flex">
    ...
    <span>Dark</span>
                        ...
                        <div className="panel">
                            ...
                            <div className="mb-5">
                                <div className="space-y-2">
                                    <RadioGroup.Root className="flex flex-col gap-2.5" defaultValue="primary" aria-label="View density">
                                        <div>
                                            <RadioGroup.Item className="form-radio" value="primary" id="r1">
                                                {' '}
                                        ...
                                        <div>
                                            <RadioGroup.Item className="form-radio text-success" value="success" id="r2">
                                                <RadioGroup.Indicator className="flex items-center justify-center w-full h-full relative after:content-[''] after:block after:w-[11px] after:h-[11px] after:rounded-[50%] after:bg-success" />
                                            </RadioGroup.Item>
                                            <label className="inline-flex">
                                                <span>Success</span>
                                            </label>
                                        ...
                                        <div>
                                            <RadioGroup.Item className="form-radio text-secondary" value="secondary" id="r3">
                                                <RadioGroup.Indicator className="flex items-center justify-center w-full h-full relative after:content-[''] after:block after:w-[11px] after:h-[11px] after:rounded-[50%] after:bg-secondary" />
                                            </RadioGroup.Item>
                                            <label className="inline-flex">
                                                <span>Secondary</span>
                                            </label>
                                        ...
                                        <div>
                                            <RadioGroup.Item className="form-radio text-danger" value="danger" id="r4">
                                                {' '}
                                                <RadioGroup.Indicator className="flex items-center justify-center w-full h-full relative after:content-[''] after:block after:w-[11px] after:h-[11px] after:rounded-[50%] after:bg-danger" />
                                            </RadioGroup.Item>
                                            <label className="inline-flex">
                                                <span>Danger</span>
                                            </label>
                                        ...
                                        <div>
                                            <RadioGroup.Item className="form-radio text-warning" value="warning" id="r5">
                                                {' '}
                                                <RadioGroup.Indicator className="flex items-center justify-center w-full h-full relative after:content-[''] after:block after:w-[11px] after:h-[11px] after:rounded-[50%] after:bg-warning" />
                                            </RadioGroup.Item>
                                            <label className="inline-flex">
                                                <span>Warning</span>
                                            </label>
                                        ...
                                        <div>
                                            <RadioGroup.Item className="form-radio text-info" value="info" id="r6">
                                                {' '}
                                                <RadioGroup.Indicator className="flex items-center justify-center w-full h-full relative after:content-[''] after:block after:w-[11px] after:h-[11px] after:rounded-[50%] after:bg-info" />
                                            </RadioGroup.Item>
                                            <label className="inline-flex">
                                                <span>Info</span>
                                            </label>
                                        ...
                                        <div>
                                            <RadioGroup.Item className="form-radio text-dark" value="dark" id="r7">
                                                {' '}
                                                <RadioGroup.Indicator className="flex items-center justify-center w-full h-full relative after:content-[''] after:block after:w-[11px] after:h-[11px] after:rounded-[50%] after:bg-dark" />
                                            </RadioGroup.Item>
                                            <label className="inline-flex">
                                                <span>Dark</span>
                                            </label>
