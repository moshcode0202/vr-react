                ...
                <div className="space-y-8" id="icons">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div className="panel">
                            ...
                            <div className="mb-5">
                                <Switch.Root className="w-12 h-6 relative" id="airplane-mode">
                        ...
                        <div className="panel">
                            ...
                            <div className="mb-5">
                                ...
                                <Switch.Root className="w-12 h-6 relative" id="airplane-mode">
                                    ...
                                    <Switch.Thumb
                                        className={`bg-[#ebedf2] dark:bg-dark block h-full before:absolute before:left-1 before:bg-white dark:before:bg-white-dark dark:peer-checked:before:bg-white before:bottom-1 before:w-4 before:h-4 peer-checked:before:left-7 peer-checked:bg-primary before:transition-all before:duration-300`}
                                    />
                                </Switch.Root>
                            </div>
