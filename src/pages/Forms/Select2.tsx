...
import * as Selectt from '@radix-ui/react-select';
    ...
    const SelectItem = forwardRef(({ children, className, ...props }, forwardedRef) => {
        return (
            <Selectt.Item
                ...
                ref={forwardedRef}
            >
                <Selectt.ItemText>{children}</Selectt.ItemText>
                <Selectt.ItemIndicator className="absolute left-0 w-[25px] inline-flex items-center justify-center">
                    <CheckIcon />
                </Selectt.ItemIndicator>
            </Selectt.Item>
        );
    });
...
<Select defaultValue={options[0]} options={options} isSearchable={false} />`}</pre>
                    ...
                    <div className="panel" id="basic">
                        ...
                        <div className="mb-5">
                            <Selectt.Root>
                                <Selectt.Trigger className="w-full inline-flex items-center justify-between rounded px-[15px] text-[13px] leading-none h-[35px] gap-[5px] bg-white text-black shadow-[0_2px_10px] shadow-black/10 hover:bg-mauve3 focus:shadow-[0_0_0_2px] focus:shadow-black data-[placeholder]:text-black outline-none">
                                    <Selectt.Value placeholder="Orange" />
                                    <Selectt.Icon className="text-black">
                                        <ChevronDownIcon />
                                    </Selectt.Icon>
                                </Selectt.Trigger>
                                <Selectt.Portal className="bg-white !w-full">
                                    <Selectt.Content side="bottom" position="popper" className="bg-white !w-full min">
                                        <Selectt.Viewport className="bg-white !w-full" style={{width:"100%"}}>
                                            <SelectItem className="bg-white !w-full" value="apple">
                                                Orange
                                            </SelectItem>
                                            <SelectItem className="bg-white !w-full" value="banana">
                                                white
                                            </SelectItem>
                                            <SelectItem className="bg-white !w-full" value="blueberry">
                                                purple
                                            </SelectItem>
                                        </Selectt.Viewport>
                                    </Selectt.Content>
                    ...
                    <div className="panel" id="nested">
                        ...
                        <div className="mb-5">
                            <Selectt.Root>
                                ...
                                <Selectt.Portal>
                                    <Selectt.Content side="bottom" position="popper">
                                        <Selectt.Viewport className="p-[5px]">
                                            <Selectt.Group className="bg-white">
                                                <Selectt.Label className="px-[25px] text-xs leading-[25px] text-mauve11">Group 1</Selectt.Label>
                                                <SelectItem value="apple">Orange</SelectItem>
                                                <SelectItem value="banana">white</SelectItem>
                                                <SelectItem value="blueberry">purple</SelectItem>
                                            </Selectt.Group>
                                            <Selectt.Group className="bg-white">
                                                <Selectt.Label className="px-[25px] text-xs leading-[25px] text-mauve11">Group 2</Selectt.Label>
                                                <SelectItem value="ghghg">Orange</SelectItem>
                                                <SelectItem value="banhgfhgfhgfana">white</SelectItem>
                                                <SelectItem value="bluhgfhgfheberry">purple</SelectItem>
                                            </Selectt.Group>
                                        </Selectt.Viewport>
                                    </Selectt.Content>
                                </Selectt.Portal>
...
<Select defaultValue={options1[1]} options={options1} isSearchable={false}/>`}</pre>
                    ...
                    <div className="panel" id="tagging">
                        ...
                        <div className="mb-5">
                            <Selectt.Root>
                                <Selectt.Trigger className="w-full inline-flex items-center justify-between rounded px-[15px] text-[13px] leading-none h-[35px] gap-[5px] bg-white text-black shadow-[0_2px_10px] shadow-black/10 hover:bg-mauve3 focus:shadow-[0_0_0_2px] focus:shadow-black data-[placeholder]:text-black outline-none">
                                    <Selectt.Value placeholder="Select an Option" className='text-black'/>
                                    <Selectt.Icon className="text-black">
                                        <ChevronDownIcon />
                                    </Selectt.Icon>
                                </Selectt.Trigger>
                                <Selectt.Portal className="bg-white !w-full">
                                    <Selectt.Content side="bottom" position="popper" className="bg-white !w-full">
                                        <Selectt.Viewport className="bg-white !w-full">
                                            <SelectItem className="bg-white !w-full" value="apple">
                                                Orange
                                            </SelectItem>
                                            <SelectItem className="bg-white !w-full" value="banana">
