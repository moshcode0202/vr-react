...
const Accordians = () => {
    ...
    const AccordionItem = React.forwardRef(({ children, className, ...props }, forwardedRef) => (
        <Accordion.Item className={classNames('border border-[#d3d3d3] dark:border-[#1b2e4b] rounded', className)} {...props} ref={forwardedRef}>
            {children}
        </Accordion.Item>
    ));
    ...
    const AccordionTrigger = React.forwardRef(({ children, className, ...props }, forwardedRef) => (
        <Accordion.Header className="flex">
            <Accordion.Trigger
                className={classNames('data-[state=open]:text-primary data-[state=closed]:text-white-dark hover:bg-mauve2 group flex h-[45px] flex-1 cursor-default items-center justify-between bg-white px-5 text-[13px] outline-none', className)}
                {...props}
                ref={forwardedRef}
            >
                {children}
                <ChevronDownIcon className="text-violet10 ease-[cubic-bezier(0.87,_0,_0.13,_1)] transition-transform duration-300 group-data-[state=open]:rotate-180" aria-hidden />
            </Accordion.Trigger>
        </Accordion.Header>
    ));

    const AccordionContent = React.forwardRef(({ children, className, ...props }, forwardedRef) => (
        <Accordion.Content className={classNames('', className)} {...props} ref={forwardedRef}>
            ...
            <div>
                <AnimateHeight duration={300} height={active === '3' ? 'auto' : 0}>
                    ...
                    <div className="panel" id="basic">
                        ...
                        <div className="mb-5">
                            <Accordion.Root type="single" defaultValue="item-1" collapsible className="space-y-2 font-semibold">
                                {/* <div className="border border-[#d3d3d3] dark:border-[#1b2e4b] rounded"> */}
                                <AccordionItem value="item-1">
                                    <AccordionTrigger>Collapsible Group Item #1</AccordionTrigger>
                                    <AccordionContent>
                                        <div className="space-y-2 p-4 text-white-dark text-[13px] border-t border-[#d3d3d3] dark:border-[#1b2e4b]">
                                            <p>
                                ...
                                <AccordionItem value="item-2">
                                    <AccordionTrigger>Collapsible Group Item #2</AccordionTrigger>
                                    <AccordionContent>
                                        <div className="p-4 text-[13px] border-t border-[#d3d3d3] dark:border-[#1b2e4b]">
                                            <ul className="space-y-1">
                                                <li>
                                ...
                                <AccordionItem value="item-3">
                                    <AccordionTrigger>Collapsible Group Item #3</AccordionTrigger>
                                    <AccordionContent>
                                        <div className="p-4 text-[13px] border-t border-[#d3d3d3] dark:border-[#1b2e4b]">
                                            <p>
