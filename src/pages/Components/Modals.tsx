...
import * as Dialogg from '@radix-ui/react-dialog';
            ...
            <div className="fixed inset-0 bg-[black]/60 z-[999] overflow-y-auto">
                <div className="flex items-start justify-center min-h-screen px-4">
                    ...
                    <div className="panel">
                        ...
                        <Dialogg.Root open={modal1} onOpenChange={setModal1}>
                            <Dialogg.Trigger asChild className="mb-5 flex items-center justify-center">
                            ...
                            <Dialogg.Portal>
                                <div className="fixed inset-0 z-[999] overflow-y-auto bg-[black]/60">
                                    <div className="flex min-h-screen items-start justify-center px-4">
                                        <Dialogg.Content className="panel my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                            <div className="flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]">
                                                <div className="text-lg font-bold">Modal Title</div>
                                                <button type="button" className="text-white-dark hover:text-dark" onClick={() => setModal1(false)}>
                                                    <svg
...
`}
                    ...
                    <div className="panel">
                        ...
                        <Dialogg.Root open={modal2} onOpenChange={setModal2}>
                            <Dialogg.Trigger asChild className="mb-5 flex items-center justify-center">
                                <button type="button" onClick={() => setModal2(true)} className="btn btn-info">
                                    Launch modal
                                </button>
...
`}
                    ...
                    <div className="panel">
                        ...
                        <Dialogg.Root open={modal3} onOpenChange={() => setModal3(true)}>
                            <Dialogg.Trigger asChild className="mb-5 flex items-center justify-center">
                                <button type="button" onClick={() => setModal3(true)} className="btn btn-secondary">
                                    Static modal
                                </button>
                    ...
                    <div className="panel">
                        ...
                        <div className="mb-5">
                            <div className="flex items-center justify-center gap-2">
                                ...
                                {/* Extra large */}
                                <Dialogg.Root open={modal5} onOpenChange={setModal5}>
                                    <Dialogg.Trigger asChild>
                                    ...
                                    <Dialogg.Portal>
                                        <div className="fixed inset-0 z-[999] bg-[black]/60">
                                            <div className="flex min-h-screen items-start justify-center px-4">
                                                <Dialogg.Content className="panel my-8 w-full max-w-5xl overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                                    <div className="flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]">
                                                        <h5 className="text-lg font-bold">Modal Title</h5>
                                                        <button onClick={() => setModal5(false)} type="button" className="text-white-dark hover:text-dark">
                                                            <svg
                                ...
                                {/* Large */}
                                <Dialogg.Root open={modal6} onOpenChange={setModal6}>
                                    <Dialogg.Trigger asChild>
                                    ...
                                    <Dialogg.Portal>
                                        <div className="fixed inset-0 z-[999] bg-[black]/60">
                                            <div className="flex min-h-screen items-start justify-center px-4">
                                                <Dialogg.Content className="panel my-8 w-full max-w-xl overflow-hidden  rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                                    <div className="flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]">
                                                        <h5 className="text-lg font-bold">Modal Title</h5>
                                                        <button onClick={() => setModal6(false)} type="button" className="text-white-dark hover:text-dark">
                                                            <svg
                                ...
                                {/* Small */}
                                <Dialogg.Root open={modal7} onOpenChange={setModal7}>
                                    <Dialogg.Trigger asChild>
                                    ...
                                    <Dialogg.Portal>
                                        <div className="fixed inset-0 z-[999] overflow-y-auto bg-[black]/60">
                                            <div className="flex min-h-screen items-start justify-center px-4">
                                                <Dialogg.Content className="panel my-8 w-full max-w-sm overflow-hidden  rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                                    <div className="flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]">
                                                        <h5 className="text-lg font-bold">Modal Title</h5>
                                                        <button onClick={() => setModal7(false)} type="button" className="text-white-dark hover:text-dark">
                                                            <svg
...
`}
                    ...
                    <div className="panel">
                        ...
                        <Dialogg.Root open={modal8} onOpenChange={setModal8}>
                            <Dialogg.Trigger asChild className="mb-5 flex items-center justify-center">
                                <button type="button" className="btn btn-primary">
                                    Play Youtube
                                </button>
                            </Dialogg.Trigger>
                            <Dialogg.Overlay className="fixed inset-0" />
                            <Dialogg.Portal>
                                <div className="fixed inset-0 z-[999] overflow-y-auto bg-[black]/60">
                                    <div className="flex min-h-screen items-start justify-center px-4">
                                        <Dialogg.Content className="my-8 w-full max-w-3xl overflow-hidden">
                                            <div className="text-right">
                                                <button onClick={() => setModal8(false)} type="button" className="text-white-dark hover:text-dark">
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="panel md:col-span-2">
                        ...
                        <div className="mb-5">
                            <div className="flex flex-wrap items-center justify-center gap-2">
                                ...
                                {/* FadeIn */}
                                <Dialogg.Root open={modal9} onOpenChange={setModal9}>
                                    <Dialogg.Trigger asChild>
                                        <button type="button" className="btn btn-primary">
                                            FadeIn
                                        </button>
                                    ...
                                    <Dialogg.Portal>
                                        <div id="fadein_modal" className="fixed inset-0 z-[999] overflow-y-auto bg-[black]/60">
                                            <div className="flex min-h-screen items-start justify-center px-4">
                                                <Dialogg.Content className="panel animate__animated animate__fadeIn my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                                    <div className="flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]">
                                                        <h5 className="text-lg font-bold">Modal Title</h5>
                                                        <button onClick={() => setModal9(false)} type="button" className="text-white-dark hover:text-dark">
                                                            <svg
                                ...
                                <Dialogg.Root open={modal10} onOpenChange={setModal10}>
                                    <Dialogg.Trigger asChild>
                                    ...
                                    <Dialogg.Portal>
                                        <div id="slideIn_down_modal" className="fixed inset-0 z-[999] overflow-y-auto bg-[black]/60">
                                            <div className="flex min-h-screen items-start justify-center px-4">
                                                <Dialogg.Content className="panel animate__animated animate__slideInDown my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                                    <div className="flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]">
                                                        <h5 className="text-lg font-bold">Modal Title</h5>
                                                        <button onClick={() => setModal10(false)} type="button" className="text-white-dark hover:text-dark">
                                                            <svg
                                ...
                                {/* FadeIn Up */}
                                <Dialogg.Root open={modal11} onOpenChange={setModal11}>
                                    <Dialogg.Trigger asChild>
                                        <button type="button" className="btn btn-success">
                                            FadeIn Up
                                        </button>
                                    ...
                                    <Dialogg.Portal>
                                        <div id="fadein_left_modal" className="fixed inset-0 z-[999] overflow-y-auto bg-[black]/60">
                                            <div className="flex min-h-screen items-start justify-center px-4">
                                                <Dialogg.Content className="panel animate__animated animate__fadeInUp my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                                    <div className="flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]">
                                                        <h5 className="text-lg font-bold">Modal Title</h5>
                                                        <button onClick={() => setModal11(false)} type="button" className="text-white-dark hover:text-dark">
                                                            <svg
                                ...
                                {/* SlideIn Up */}
                                <Dialogg.Root open={modal12} onOpenChange={setModal12}>
                                    <Dialogg.Trigger asChild>
                                        <button type="button" className="btn btn-warning">
                                            SlideIn Up
                                        </button>
                                    ...
                                    <Dialogg.Portal>
                                        <div id="slidein_up_modal" className="fixed inset-0 z-[999] overflow-y-auto bg-[black]/60">
                                            <div className="flex min-h-screen items-start justify-center px-4">
                                                <Dialogg.Content className="panel animate__animated animate__slideInUp my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                                    <div className="flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]">
                                                        <h5 className="text-lg font-bold">Modal Title</h5>
                                                        <button onClick={() => setModal12(false)} type="button" className="text-white-dark hover:text-dark">
                                                            <svg
                                ...
                                {/* FadeIn Left */}
                                <Dialogg.Root open={modal13} onOpenChange={setModal13}>
                                    <Dialogg.Trigger asChild>
                                        <button type="button" className="btn btn-danger">
                                            FadeIn Left
                                        </button>
                                ...
                                {/* RotateIn Left */}
                                <Dialogg.Root open={modal14} onOpenChange={setModal14}>
                                    <Dialogg.Trigger asChild>
                                        <button type="button" className="btn btn-secondary">
                                            RotateIn Left
                                        </button>
                                ...
                                {/* FadeIn Right */}
                                <Dialogg.Root open={modal15} onOpenChange={setModal15}>
                                    <Dialogg.Trigger asChild>
                                ...
                                {/* ZoomIn Up*/}
                                <Dialogg.Root open={modal16} onOpenChange={setModal16}>
                                    <Dialogg.Trigger asChild>
                                        <button type="button" className="btn btn-primary">
                                            ZoomIn Up
                                        </button>
                                    ...
                                    <Dialogg.Portal>
                                        <div id="zoomIn_up_modal" className="fixed inset-0 z-[999] overflow-y-auto bg-[black]/60">
                                            <div className="flex min-h-screen items-start justify-center px-4">
                                                <Dialogg.Content className="panel animate__animated animate__zoomInUp my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                                    <div className="flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]">
                                                        <h5 className="text-lg font-bold">Modal Title</h5>
                                                        <button onClick={() => setModal16(false)} type="button" className="text-white-dark hover:text-dark">
                                                            <svg
                    ...
                    <div className="panel md:col-span-2">
                        ...
                        <div className="mb-5">
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-2">
                                ...
                                {/* standard */}
                                <Dialogg.Root open={modal17} onOpenChange={setModal17}>
                                    <Dialogg.Trigger asChild>
                                        <button type="button" className="btn btn-primary">
                                            Standard
                                        </button>
                                            ...
                                            <div className="flex min-h-screen items-start justify-center px-4">
                                                <Dialogg.Content className="panel my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                                    ...
                                                    <div className="p-5">
                                                        <div className="text-center text-sm text-white-dark">
                                                            <p>
                                                                Vivamus vitae hendrerit neque. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Morbi consequat
                                                                auctor turpis, vitae dictum augue efficitur vitae. Vestibulum a risus ipsum. Quisque nec lacus dolor. Quisque ornare tempor orci id
                                                                rutrum.
                                                            </p>
                                                        </div>
                                                        <div className="mt-8 flex items-center justify-end">
                                ...
                                {/* tabs */}
                                <Dialogg.Root open={modal18} onOpenChange={setModal18}>
                                    <Dialogg.Trigger asChild>
                                        <button type="button" className="btn btn-info">
                                            Tabs
                                        </button>
                                        ...
                                        <div id="tabs_modal" className="fixed inset-0 z-[999] overflow-y-auto bg-[black]/60">
                                            <div className="flex min-h-screen items-start justify-center px-4">
                                                <Dialogg.Content className="panel my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                                    ...
                                                    <div className="p-5">
                                                        <Tabss.Root defaultValue="tab1">
                                                            <Tabss.List className="mt-3 flex flex-wrap border-b border-white-light dark:border-[#191e3a]">
                                                                <Tabss.Trigger
                                                                    value="tab1"
                                                                    className="dark:hover:border-b-black' -mb-[1px] block border border-transparent p-3.5 py-2 hover:text-primary data-[state=active]:!border-white-light data-[state=active]:!border-b-white data-[state=active]:text-primary data-[state=active]:!outline-none data-[state=active]:dark:!border-[#191e3a] data-[state=active]:dark:!border-b-black"
                                                                >
                                                                    Home
                                                                </Tabss.Trigger>
                                                                <Tabss.Trigger
                                                            ...
                                                            <div>
                                                                ...
                                                                {/* <Tabss.Content value="tab4">Disabled</Tabss.Content> */}
                                                            </div>
                                                        </Tabss.Root>
                                                        <div className="mt-8 flex items-center justify-end">
                                                            <button onClick={() => setModal18(false)} type="button" className="btn btn-outline-danger">
                                ...
                                {/* profile */}
                                <Dialogg.Root open={modal19} onOpenChange={setModal19}>
                                    <Dialogg.Trigger asChild>
                                        <button type="button" onClick={() => setModal19(true)} className="btn btn-success">
                                            Profile
                                        </button>
                                    ...
                                    <Dialogg.Portal>
                                        <div id="profile_modal" className="fixed inset-0 z-[999] overflow-y-auto bg-[black]/60">
                                            <div className="flex min-h-screen items-start justify-center px-4">
                                                <Dialogg.Content className="panel my-8 w-full max-w-[300px] overflow-hidden rounded-lg border-0 bg-secondary p-0 text-black dark:bg-secondary dark:text-white-dark">
                                                    <div className="flex items-center justify-end pt-4 text-white ltr:pr-4 rtl:pl-4 dark:text-white-light">
                                                        <button onClick={() => setModal19(false)} type="button" className="text-white-dark hover:text-dark">
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                ...
                                {/* login */}
                                <Dialogg.Root open={modal20} onOpenChange={setModal20}>
                                    <Dialogg.Trigger asChild>
                                        <button type="button" onClick={() => setModal20(true)} className="btn btn-warning">
                                            Login
                                        </button>
                                    ...
                                    <Dialogg.Portal>
                                        <div id="login_modal" className="fixed inset-0 z-[999] overflow-y-auto bg-[black]/60">
                                            <div className="flex min-h-screen items-start justify-center px-4">
                                                <Dialogg.Content className="panel my-8 w-full max-w-sm overflow-hidden rounded-lg border-0 py-1 px-4 text-black dark:text-white-dark">
                                                    <div className="flex items-center justify-between p-5 text-lg font-semibold dark:text-white">
                                                        <h5>Login</h5>
                                                        <button type="button" onClick={() => setModal20(false)} className="text-white-dark hover:text-dark">
                                                            <svg
                                ...
                                {/* Register */}
                                <Dialogg.Root open={modal21} onOpenChange={setModal21}>
                                    <Dialogg.Trigger asChild>
                                        <button type="button" onClick={() => setModal21(true)} className="btn btn-danger">
                                            Register
                                        </button>
                                ...
                                {/* slider */}
                                <Dialogg.Root open={modal22} onOpenChange={setModal22}>
                                    <Dialogg.Trigger asChild>
                                        <button type="button" onClick={() => setModal22(true)} className="btn btn-secondary">
                                            Slider
                                        </button>
                                    ...
                                    <Dialogg.Portal>
                                        <div id="slider_modal" className="fixed inset-0 z-[999] overflow-y-auto bg-[black]/60">
                                            <div className="flex min-h-screen items-start justify-center px-4">
                                                <Dialogg.Content className="animate__animated animate__fadeIn panel my-8 w-full max-w-xl overflow-hidden rounded-lg border-0 py-1 px-4">
                                                    <div className="flex items-center justify-between py-5 text-lg font-semibold dark:text-white">
                                                        <span>Slider</span>
                                                        <button onClick={() => setModal22(false)} type="button" className="text-white-dark hover:text-dark">
                                                            <svg
