                        ...
                        <div className="mb-5">
                            <Tabss.Root defaultValue="tab1">
                                <Tabss.List className="mt-3 flex flex-wrap border-b border-white-light dark:border-[#191e3a]">
                                    ...
                                    {/* <Tabss.Trigger value="tab4" className="pointer-events-none -mb-[1px] block p-3.5 py-2 text-white-light outline-none dark:text-dark">
                                        Disabled
                                    </Tabss.Trigger> */}
                                </Tabss.List>
                                <div>
...
`}
                    ...
                    <div className="panel" id="pills">
                        ...
                        <div className="mb-5">
                            <Tabss.Root defaultValue="tab1">
                                <Tabss.List className="mt-3 flex flex-wrap">
                                    <Tabss.Trigger
                                        value="tab1"
                                        className="-mb-[1px] block rounded p-3.5 py-2 hover:bg-primary hover:text-white ltr:mr-2 rtl:ml-2 data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:!outline-none"
                                    >
                                        Home
                                    </Tabss.Trigger>
                                    <Tabss.Trigger
                                        value="tab2"
                                        className="data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:!outline-none -mb-[1px] block rounded p-3.5 py-2 hover:bg-primary hover:text-white ltr:mr-2 rtl:ml-2"
                                    >
                                        Profile
                                    </Tabss.Trigger>
                                    <Tabss.Trigger
                                    ...
                                    <Tabss.Trigger value="tab4" className="pointer-events-none -mb-[1px] block rounded p-3.5 py-2 text-white-light dark:text-dark">
                                        Disabled
                                    </Tabss.Trigger>
                                </Tabss.List>
                                <div>
