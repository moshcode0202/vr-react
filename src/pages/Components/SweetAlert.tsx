                            ...
                            <div className="flex items-center justify-center">
                                <AlertDialog.Root>
                                    <AlertDialog.Trigger asChild>
                                        <button className="btn btn-primary">Basic message</button>
                                    </AlertDialog.Trigger>
                                    <AlertDialog.Portal className="sweet-alerts">
                                        <AlertDialog.Content className="sweet-alerts data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[500px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                                            <AlertDialog.Title className="text-mauve12 m-0 text-[17px] font-medium">Saved succesfully</AlertDialog.Title>
                    ...
                    <div className="panel">
                        ...
                        <div className="mb-5">
                            <div className="flex items-center justify-center">
                                <AlertDialog.Root>
                                    <AlertDialog.Trigger asChild>
                                        <button className="btn btn-secondary"> Success message!</button>
                                    </AlertDialog.Trigger>
                                    <AlertDialog.Portal className="sweet-alerts">
                                        <AlertDialog.Content className="sweet-alerts data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[500px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                                            <AlertDialog.Title className="text-mauve12 m-0 text-[17px] font-medium">Good job!</AlertDialog.Title>
                                            <AlertDialog.Description>You clicked the!</AlertDialog.Description>{' '}
                                            <AlertDialog.Cancel asChild>
                                                <button className="btn btn-primary">ok</button>
                                            </AlertDialog.Cancel>
                                        </AlertDialog.Content>
                    ...
                    <div className="panel">
                        ...
                        <div className="mb-5">
                            <div className="flex items-center justify-center">
                                <AlertDialog.Root>
                                    <AlertDialog.Trigger asChild>
                                        <button className="btn btn-success"> Dynamic queue</button>
                                    </AlertDialog.Trigger>
                                    <AlertDialog.Portal className="sweet-alerts">
                                        <AlertDialog.Content className="sweet-alerts data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[500px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                                            <AlertDialog.Title className="text-mauve12 m-0 text-[17px] font-medium">Your public IP</AlertDialog.Title>
                                            <AlertDialog.Description>Your public IP will be received via AJAX request</AlertDialog.Description>{' '}
                                            <AlertDialog.Cancel asChild>
                                                <button className="btn btn-primary">Show my public IP</button>
                                            </AlertDialog.Cancel>
                                        </AlertDialog.Content>
                                    </AlertDialog.Portal>
                                </AlertDialog.Root>
                    ...
                    <div className="panel">
                        ...
                        <div className="mb-5">
                            <div className="flex items-center justify-center">
                                <AlertDialog.Root>
                                    <AlertDialog.Trigger asChild>
                                        <button className="btn btn-danger">Title & text</button>
                                    </AlertDialog.Trigger>
                                    <AlertDialog.Portal className="sweet-alerts">
                                        <AlertDialog.Content className="sweet-alerts data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[500px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                                            <AlertDialog.Title className="text-mauve12 m-0 text-[17px] font-medium">The Internet?</AlertDialog.Title>
                                            <AlertDialog.Description>That thing is still around?</AlertDialog.Description>{' '}
                                            <AlertDialog.Cancel asChild>
                                                <button className="btn btn-primary">ok</button>
                                            </AlertDialog.Cancel>
                                        </AlertDialog.Content>
                    ...
                    <div className="panel">
                        ...
                        <div className="mb-5">
                            <div className="flex items-center justify-center">
                                <AlertDialog.Root>
                                    <AlertDialog.Trigger asChild>
                                        <button className="btn btn-warning">Chaining modals (queue)</button>
                                    </AlertDialog.Trigger>
                                    <AlertDialog.Portal className="sweet-alerts">
                                        <AlertDialog.Content className="sweet-alerts data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[500px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                                            <AlertDialog.Title className="text-mauve12 m-0 text-[17px] font-medium">Question 1</AlertDialog.Title>
